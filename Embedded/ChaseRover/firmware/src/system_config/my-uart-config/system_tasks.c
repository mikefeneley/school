...
static void _COORDINATOR_Tasks(void);
static void _MONITOR_Tasks(void);
static void _MOTOR_Tasks(void);
static void _SENSOR_Tasks(void);
static void _MESSAGE_Tasks(void);
...
void SYS_Tasks ( void )
{
    ...
    /* Create OS Thread for COORDINATOR Tasks. */
    xTaskCreate((TaskFunction_t) _COORDINATOR_Tasks,
                "COORDINATOR Tasks",
                1024, NULL, 1, NULL);

    /* Create OS Thread for MONITOR Tasks. */
    ...
    /* Create OS Thread for MESSAGE Tasks. */
    xTaskCreate((TaskFunction_t) _MESSAGE_Tasks,
                "MESSAGE Tasks",
                1024, NULL, 1, NULL);
...
/*******************************************************************************
  Function:
    void _COORDINATOR_Tasks ( void )

  Summary:
    Maintains state machine of COORDINATOR.
*/
...
/*******************************************************************************
  Function:
    void _MONITOR_Tasks ( void )

  Summary:
    Maintains state machine of MONITOR.
*/
...
/*******************************************************************************
  Function:
    void _MESSAGE_Tasks ( void )

  Summary:
    Maintains state machine of MESSAGE.
*/
